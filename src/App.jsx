    ...
    <div className="App">
      ...
      <section className="projects">
        <div className="container">
          ...
          <div className="card-grid">
            <div className="card">
              <img src={`${import.meta.env.BASE_URL}images/foodpanda.jpg`} alt="FoodPanda Ordering App" className="card-image" />
            ...
            <div className="card">
              <img src={`${import.meta.env.BASE_URL}images/textile.png`} alt="Textile Management System" className="card-image" />
              <div className="card-content">
            ...
            <div className="card">
              <img src={`${import.meta.env.BASE_URL}images/dustbin.jpg`} alt="Smart Motion-Detecting Dustbin" className="card-image" />
              <div className="card-content">
      ...
      <section className="work">
        <div className="container">
          ...
          <div className="card-grid">
            <div className="card">
              <img src={`${import.meta.env.BASE_URL}images/clicksotic.jpeg`} alt="Clicksotic logo" className="card-image" />
              <div className="card-content">
            ...
            <div className="card">
              <img src={`${import.meta.env.BASE_URL}images/aitomation.jpg`} alt="Aitomation logo" className="card-image" />
              <div className="card-content">
      ...
      <section className="internships">
        <div className="container">
          ...
          <div className="card-grid">
            <div className="card">
              <img src={`${import.meta.env.BASE_URL}images/netsol.png`} alt="Netsol logo" className="card-image" />
              <div className="card-content">
                <h3>Intern</h3>
            ...
            <div className="card">
              <img src={`${import.meta.env.BASE_URL}images/omnilife.png`} alt="Omnilife logo" className="card-image" />
              <div className="card-content">
